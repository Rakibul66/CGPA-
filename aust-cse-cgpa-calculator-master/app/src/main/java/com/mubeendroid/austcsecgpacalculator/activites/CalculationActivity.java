        ...
        if (extras != null) {
            switch (extras.getString("fetch")) {
                ...
                case "12":
                    ...
                    break;
                case "13":
                    heading.setText("1st year 3rd semester");
                    map = information.get13Data();
                    year = 1;
                    semester = 3;
                    break;
                case "21":
                ...
                case "22":
                    ...
                    break;
                case "23":
                    heading.setText("2nd year 3rd semester");
                    map = information.get23Data();
                    year =2;
                semester = 3;
                    break;
                case "31":
                ...
                case "32":
                    ...
                    break;
                case "33":
                    heading.setText("3rd year 3rd semester");
                    map = information.get33Data();
                    year = semester = 3;
                    break;
                case "41":
                ...
                case "42":
                    ...
                    break;
                case "43":
                    heading.setText("4th year 3rd semester");
                    map = information.get43Data();
                    year = 4;
                    semester = 3;
                    break;
            }
